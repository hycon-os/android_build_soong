...
var (
	...
	hyconResTag           = dependencyTag{name: "com.hycon.platform-res"}
...
func (j *Module) deps(ctx android.BottomUpMutatorContext) {
	if ctx.Device() {
		...
		if ctx.ModuleName() == "framework" || ctx.ModuleName() == "framework-annotation-proc" {
			ctx.AddDependency(ctx.Module(), hyconResTag, "com.hycon.platform-res")
		}
		...
		if ctx.ModuleName() == "com.hycon.platform-res" {
			ctx.AddDependency(ctx.Module(), frameworkResTag, "framework-res")
		}
		if ctx.ModuleName() == "com.hycon.platform" ||
			ctx.ModuleName() == "com.hycon.platform.internal" ||
			ctx.ModuleName() == "com.hycon.platform.sdk" {
			ctx.AddDependency(ctx.Module(), hyconResTag, "com.hycon.platform-res")
		}
	}
		...
		case Dependency:
			...
			case hyconResTag:
				if ctx.ModuleName() == "com.hycon.platform" ||
					ctx.ModuleName() == "com.hycon.platform.internal" ||
					ctx.ModuleName() == "com.hycon.platform.sdk" {
					// com.hycon.platform.jar has a one-off dependency on the R.java and Manifest.java files
					// generated by com.hycon.platform-res.apk
